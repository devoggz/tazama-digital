...
const finishIcons: Record<string, React.ReactNode> = {
  ...
  Chrome: <Sparkles size={18} />,
  Metallic: <Sparkles size={18} />,
  "3M Vinyl": <Layers size={18} />,
  Removable: <Droplets size={18} />,
  "UV Protected": <ShieldCheck size={18} />,
  "Anti-Slip": <ShieldCheck size={18} />,
};
